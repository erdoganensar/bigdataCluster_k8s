...
if [ -n "$POD_NAME" ]; then
    ...
    echo -e "\033[41;37m parameters you can input are:node-type(default:master),slave count(default:3), pod owner(default:hvl),cluster name((default:bigdata)) \033[0m"
